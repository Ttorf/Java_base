...
public class Test {
    ...
    public static void main(String[] args) throws ItemStoreException, ItemAlreadyPlacedException {
       Test test = new Test();
       test.addProperties();
        test.box.addItemToContainer(test.materialBuild);
        test.box.addItemToContainer(test.box2);
        test.box.getItem();
        test.box.getItem();
    }
}
